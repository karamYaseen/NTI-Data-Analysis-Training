...
This section contains Data Query Language (DQL) tasks practiced during SQL training.
...
14. Insert another employee with personal data your friend as new employee in department number 30,
   SSN = 102660,
   without entering any value for salary or supervisor number.
...
- Tasks focus on SELECT statements, filtering, joins, and basic DML operations.
