...
- **Data Types**: Numbers (integers, floats), strings, booleans, None
- **Variables**: Assignment, multiple assignments, augmented assignment
- **Mathematical Operations**: Arithmetic, power, division types, remainder
- **String Operations**: Creation, escaping, concatenation, built-in methods
- **User Input**: Getting input, type conversion
- **Type System**: Dynamic typing, type checking, object methods
...
- **Lists**: Creation, indexing, modification, operations
  ...
  - List comprehensions
  - Slicing and copying
- **Tuples**: Immutable sequences, creation, methods
- **Strings as Sequences**: Character access, immutability
...
- Work with Python's basic data types and operations
- Create and manipulate lists and tuples
- Handle user input and type conversions
- Use boolean logic and comparison operations
